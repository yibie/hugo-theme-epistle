...
| **文章往来** | 每封信下方都可匿名来信；投递先进入私人收件箱，获许可且经作者回复后才会公开 |
...
「往来」不是公开评论区。每篇文章的下半部分先展示读者与作者已经公开的书信；点击「往来」即可写信，暂无来信时则直接显示信笺。访客可以匿名投递，邮件地址只用于作者私下回复。

来信先进入私人 GitHub 仓库。只有访客允许公开、作者留下公开回复并批准后，系统才会向 Hugo 内容仓库提交一份不含邮箱的 PR；公开内容只出现在它所回应的文章下方。
