...
书信引用古文典故时，可为生僻字或专名加行间注释，注文出现在字的正上方，与注音不同——行间注写的是**释义**，而非读音：

{{< annotation >}}
<p>臣本<ruby>布衣<rp>（</rp><rt>平民百姓</rt><rp>）</rp></ruby>，躬耕于<ruby>南阳<rp>（</rp><rt>今河南南阳</rt><rp>）</rp></ruby>，苟全性命于乱世，不求闻达于诸侯。</p>
{{< /annotation >}}

行内单处注释可直接写原生 `<ruby>` 标签，或用 `ruby` shortcode：「{{< ruby text="赫蹏" ruby="古代薄纸" >}}」——Heti 名字即取自此典。
